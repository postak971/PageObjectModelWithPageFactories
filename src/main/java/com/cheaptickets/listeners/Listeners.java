package com.cheaptickets.listeners;
...
import com.cheaptickets.utilities.ExtentManager;
import com.cheaptickets.utilities.MonitoringMail;
import com.cheaptickets.utilities.TestConfig;
...
public class Listeners extends Page implements ITestListener,ISuiteListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			...
			Utilities.captureScreenshot(); //accessing the screenshot from TestUtil class.
	...
	Reporter.log("<br />");
	Reporter.log("<a target =\" _blank\" href = "+Utilities.screenshotName+"><img src ="+Utilities.screenshotName+" height =\"100\" width = \"150\"></img></a>");
	...
	public void onFinish(ISuite suite) {
		...
		try {
			messageBody = "http://" + InetAddress.getLocalHost().getHostAddress() + ":9091/job/PageObjectWithFactory/Extent_20Report/";
